...
from src.config_dec import exp_folder
FLAGS = flags.FLAGS
...
def create_reconst_summary(enc, dec, data_loaders_labeled, train_labeled, epoch, img_xfm_norm_inv, sum_writer, depth_extractor=None):
    ...
    save_image(image_D_sbs_gt_train, pjoin(exp_folder(),f'train_e{epoch}.png'))
    save_image(image_D_sbs_gt_test, pjoin(exp_folder(),f'test_e{epoch}.png'))
