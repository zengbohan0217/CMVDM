...
class DDPM(pl.LightningModule):
    ...
    def __init__(self,
        ...
        # here to deal a mimic model to generate the depth map
        # self.mimic_model = mimic_model()
        # self.mimic_model = BaseDecoder(in_dim=1696, out_img_res=512)
        self.mimic_model = BaseDecoder(in_dim=data_input_dim, out_img_res=112, n_chan_output=3)
        ...
        self.mimic_model.load_state_dict(dict_depth_new, strict=True)
    ...
    def full_validation(self, batch, state=None):
        ...
        # grid, all_samples, state = self.generate(batch, ddim_steps=self.ddim_steps, num_samples=5, limit=30, state=state)
...
class LatentDiffusion(DDPM):
    ...
    def configure_optimizers(self):
        ...
        if self.train_cond_stage_only:
            ...
            # depth_params = list(self.mimic_model.parameters())
